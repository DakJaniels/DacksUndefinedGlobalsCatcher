...
local strings = {
    ...
    DACKS_UNDEFINED_GLOBALS_CATCHER_BTN_IGNORE_GLOBAL = "グローバルを無視",
    DACKS_UNDEFINED_GLOBALS_CATCHER_BTN_IGNORE_FUNCTION = "上位関数を無視",
    DACKS_UNDEFINED_GLOBALS_CATCHER_TOOLBAR_SEARCH = "検索:",
    DACKS_UNDEFINED_GLOBALS_CATCHER_TOOLBAR_SEARCH_TT = "グローバル名またはスタックフレームでフィルター。",
    DACKS_UNDEFINED_GLOBALS_CATCHER_SEARCH_PLACEHOLDER = "global or frame...",
    DACKS_UNDEFINED_GLOBALS_CATCHER_TOOLBAR_CLEAR_TT = "インシデントをすべてクリア",
    DACKS_UNDEFINED_GLOBALS_CATCHER_TOOLBAR_RESET_TT = "フィルターをリセット",
    DACKS_UNDEFINED_GLOBALS_CATCHER_TOOLBAR_CLOSE_TT = "ウィンドウを閉じる",
    DACKS_UNDEFINED_GLOBALS_CATCHER_LIST_EMPTY = "表示するものはありません",
    DACKS_UNDEFINED_GLOBALS_CATCHER_CLEAR_DIALOG_TITLE = "インシデントをクリア",
    DACKS_UNDEFINED_GLOBALS_CATCHER_CLEAR_DIALOG_TEXT = "リストからすべてのインシデントを削除しますか？カウントはリセットされません。",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_COUNT_TT = "ルックアップ回数で報告: <<1>>",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_TITLE = "グローバル: <<1>>",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_UNDEFINED = "状態: 未定義 (_G は nil)",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_DEFINED = "状態: 定義済み (<<1>>)",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_VALUE = "値: <<1>>",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_KEY_TYPE = "ルックアップキーの型: <<1>>",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_FRAME = "トップフレーム: <<1>>",
