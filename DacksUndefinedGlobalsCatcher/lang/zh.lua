...
local strings = {
    ...
    -- Mode
    DACKS_UNDEFINED_GLOBALS_CATCHER_MODE_GLOBALS = "全域變數",
    DACKS_UNDEFINED_GLOBALS_CATCHER_MODE_FUNCTIONS = "函數",

    -- Button
    DACKS_UNDEFINED_GLOBALS_CATCHER_BTN_ADD = "新增",
    DACKS_UNDEFINED_GLOBALS_CATCHER_BTN_REMOVE = "移除",
    DACKS_UNDEFINED_GLOBALS_CATCHER_BTN_IGNORE_GLOBAL = "忽略全局",
    DACKS_UNDEFINED_GLOBALS_CATCHER_BTN_IGNORE_FUNCTION = "忽略顶层函数",
    DACKS_UNDEFINED_GLOBALS_CATCHER_TOOLBAR_SEARCH = "搜索:",
    DACKS_UNDEFINED_GLOBALS_CATCHER_TOOLBAR_SEARCH_TT = "按全局名或堆栈帧筛选。",
    DACKS_UNDEFINED_GLOBALS_CATCHER_SEARCH_PLACEHOLDER = "global 或 frame...",
    DACKS_UNDEFINED_GLOBALS_CATCHER_TOOLBAR_CLEAR_TT = "清除所有事件",
    DACKS_UNDEFINED_GLOBALS_CATCHER_TOOLBAR_RESET_TT = "重置筛选",
    DACKS_UNDEFINED_GLOBALS_CATCHER_TOOLBAR_CLOSE_TT = "关闭窗口",
    DACKS_UNDEFINED_GLOBALS_CATCHER_LIST_EMPTY = "无内容",
    DACKS_UNDEFINED_GLOBALS_CATCHER_CLEAR_DIALOG_TITLE = "清除事件",
    DACKS_UNDEFINED_GLOBALS_CATCHER_CLEAR_DIALOG_TEXT = "从列表中删除所有事件？计数不会重置。",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_COUNT_TT = "在查找次数时报告: <<1>>",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_TITLE = "全局: <<1>>",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_UNDEFINED = "状态: 未定义 (_G 中为 nil)",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_DEFINED = "状态: 已定义 (<<1>>)",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_VALUE = "值: <<1>>",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_KEY_TYPE = "查找键类型: <<1>>",
    DACKS_UNDEFINED_GLOBALS_CATCHER_ROW_GLOBAL_TT_FRAME = "顶层帧: <<1>>",

    -- Message
    DACKS_UNDEFINED_GLOBALS_CATCHER_MSG_EMPTY_INPUT = "請先輸入名稱或模式。",
